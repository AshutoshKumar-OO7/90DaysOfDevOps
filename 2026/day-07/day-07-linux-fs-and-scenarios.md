...
/ (root) - The base of entire file system. All other directories branch from here. I would use this to get into the root of Linux file system.

/home - Home directories of users. Contains personal directories for each user. They can use their own home directory without requiring permissions. I would use this to list home directories of all users.
...
/etc - It contains configuration files of services, applications and the system itself. Also contains cnfiguraion files of users and passwords.
...
/var/log - Contains log files generated by services, application and operating system. These logs are critical for troubleshooting, monitoring and auditing.
...
<img width="975" height="847" alt="Screenshot (67)" src="https://github.com/user-attachments/assets/415b6f96-06fb-4aa8-a12f-98786c20c04c" />
